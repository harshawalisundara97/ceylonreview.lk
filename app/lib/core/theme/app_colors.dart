...
abstract final class AppColors {
  ...
  // (design_handoff_ceylonreview_mobile/README.md) — dark mode is opt-in via
  // the existing Profile > Dark Mode toggle; the light Ceylon Green theme
  // stays the app default.
  static const surfaceDark = Color(0xFF161826); // Nocturne "bg"
  static const surfaceBrightDark = Color(0xFF3A3D4D);
  static const surfaceContainerLowestDark = Color(0xFF0E0F18); // "bg deep"
